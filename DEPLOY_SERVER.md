...
CLIENT_FACE_MATCH_THRESHOLD=0.60
CLIENT_FACE_DUPLICATE_THRESHOLD=0.60
CLIENT_FACE_SCAN_CANDIDATES=20
CLIENT_FACE_MULTI_MATCH_MIN_HITS=2
CLIENT_FACE_MATCH_MARGIN=0.035
```
